...
function(IconSystem, $, Ajax, Mustache, LocalStorage, Url) {
    ...
    IconSystemFontawesome.prototype.init = function() {
        ...
        var map = LocalStorage.get('theme_foundation/iconmap-fontawesome');
        if (map) {
            map = JSON.parse(map);
        }
        ...
        return fetchMap.then(function(map) {
            ...
            LocalStorage.set('theme_foundation/iconmap-fontawesome', JSON.stringify(staticMap));
            return this;
        }.bind(this));
    };
    ...
    return IconSystemFontawesome; // @alias module:theme_foundation/icon_system_fontawesome
