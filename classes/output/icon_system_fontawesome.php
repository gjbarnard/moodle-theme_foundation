...
class icon_system_fontawesome extends \core\output\icon_system_fontawesome {
    ...
    public function get_core_icon_map() {
        ...
        return [
            ...
            'core:e/file-text' => 'fa-file-text TODO',
            ...
            'core:e/styleparagraph' => 'fa-font TODO',
            ...
            'core:i/addblock' => 'fa-plus-square TODO',
            ...
            'core:i/checkedcircle' => 'fa-check-circle TODO',
            ...
            'core:i/course' => 'fa-graduation-cap TODO',
            'core:i/courseevent' => 'fas fa-university',
            'core:i/customfield' => 'fa-hand-o-right TODO',
            ...
            'core:i/location' => 'fa-map-marker TODO',
            'core:i/lock' => 'fas fa-lock',
            ...
            'core:i/muted' => 'fa-microphone-slash TODO',
            ...
            'core:i/privatefiles' => 'fa-file-o TODO',
            ...
            'core:i/trash' => 'fa-trash TODO',
            'core:i/twoway' => 'fas fa-arrows-alt-h',
            'core:i/unchecked' => 'far fa-square',
            'core:i/uncheckedcircle' => 'fa-circle-o TODO',
            ...
            'core:i/window_close' => 'fa-window-close TODO',
            ...
            'core:t/downlong' => 'fa-long-arrow-down TODO',
            ...
            'core:t/emptystar' => 'fa-star-o TODO',
...
if (empty($data['key'])) {
    error_log('lloggy '.print_r($data, true));
}
        return $output->render_from_template('theme_foundation/pix_icon_fontawesome', $data);
    }
}
